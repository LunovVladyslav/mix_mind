@echo off
title MixMind Bridge — VST3 Installer
color 0B

echo.
echo  ╔══════════════════════════════════════╗
echo  ║   MixMind Bridge — VST3 Installer  ║
echo  ╚══════════════════════════════════════╝
echo.
...
set "SRC=c:\Users\vlady\Desktop\MixMind\vst-plugin\build\MixMindBridge_artefacts\Release\VST3\MixMind Bridge.vst3"
set "DST=C:\Program Files\Common Files\VST3\MixMind Bridge.vst3"

echo  Installing MixMind Bridge to:
echo  %DST%
echo.

if not exist "%SRC%\Contents\x86_64-win\MixMind Bridge.vst3" (
...
if %RCCODE% lss 8 (
    ...
    echo  4. Find "MixMind Bridge" in your plugin list
    echo.
) else (
    echo.
